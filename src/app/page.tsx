 ...
 <p> 56€ pour 1 discipline, 112€ pour 2 disciplines, 168€ pour 3 disciplines. La licence est obligatoire et le montant est directement reversé à la FFJDA. Elle comprend une assurance fédérale. </p>
  ...
  <p>  Un adulte qui ne pratique que le kendo 1 ou 2 fois par semaine : 130€+56€ = 186€</p>
   <p> Un jeune qui pratique à la fois kendo, jodo et iaido : 100€+56€+56€+56€ = 268€ </p>
      ...
      <p>Pour valider votre inscription définitive, prévoir un <strong>certificat médical</strong> pour la pratique du kendo, jodo, iaido (on conseille de faire renseigner les 3 disciplines même si une seule vous intéresse au début !) </p>
      <p>Le certificat médical est facultatif pour les <strong>jeunes de moins de 18 ans</strong>, il vous sera demandé de remplir un simple questionnaire de santé.</p>
